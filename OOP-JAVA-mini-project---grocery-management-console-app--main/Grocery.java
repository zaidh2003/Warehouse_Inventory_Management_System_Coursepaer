...
class Grocery implements GroceryOperations{
	...
	Grocery () {
		...
		do {
			...
			while (!input.hasNextDouble()) {
					System.out.println("Oops, Price can only be positive. You cant sell an Item in a negative price now can you? at least I can't. So please kindly insert positive price (don't overcharge people ;_; )");
					input.next();
			}
	...
	public void showList() {
		...
		System.out.println("=> " +  groceryName + ",  Manufacturer: " +  groceryManufacturer + ",  Price: Eu " +  price + ",  availability: " +  availableQuantity );
