...
public class Start {
	public static void main(String[] args) {
		...
		System.out.println("\n ====== Welcome to Grocery Shop Management Program ====== \n");
        ...
        while (isProgrameOpen) {
				...
				switch (option2) {
					...
					if (G1.insertGrocery(id1)) {
						...
						System.out.println("\nSorry Edible Grocery Stock Full. Please sell the grocery product in a different shop. You can always create a new shop..... \n");
					}
							...
							if (G1.insertGrocery(id2)) {
								...
								System.out.println("\nSorry NonEdible Grocery Stock Full. Please sell the grocery product in a different shop. You can always create a new shop..... \n");
							}
					...
					while (inManagingAndSearching == true) {
								...
								if(i<5){
									...
									Edibles ed1 = new Edibles(dummy[i], "BestFood", 25, 50, 5);
										...
										if (G1.insertGrocery(ed1)) {
											System.out.println("\nby Default adding Edible Grocery to inventory Successful \n");
										} else {
											System.out.println("\nSorry NonEdible Grocery Stock Full. Please sell the grocery product in a different shop. You can always create a new shop..... \n");
										}
								} else {
									...
									if (G1.insertGrocery(Ned1)) {
										System.out.println("\nby Default adding Non Edible Grocery to inventory Successful  \n");
									} else {
												System.out.println("\nSorry NonEdible Grocery Stock Full. Please sell the grocery product in a different shop. You can always create a new shop..... \n");
								}
						...
						System.out.println("\n Populating the shop with by default products values has been successful. . . . . . .\n");
